        ...
        <div className="flex flex-col xl:flex-row items-start gap-6 md:gap-12">
            ...
            <div className="basis-[65%]">
                <div className="relative">
                    ...
                    {/* Apply Card */}
                    <div className="absolute bottom-[-120px] right-[-60px] flex flex-col md:flex-row justify-center md:justify-around items-center gap-3 md:gap-10 bg-surface px-2 py-4 md:px-6 md:py-10 w-[320px] md:w-3xl">
                        <p className="flex-1 text-xl md:text-4xl text-primary font-[900] px-4 md:px-0">
